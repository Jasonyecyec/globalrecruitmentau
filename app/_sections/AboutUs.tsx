      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold text-[#1E1147] mb-6">
              Why Choose Global Recruitment
            </h2>
            <p className="text-lg text-gray-600 mb-6">
              With over two decades of experience, we've revolutionized the way
              companies and talent connect across the globe. Our commitment to
              excellence and innovation sets us apart in the recruitment
              industry.
              {/* With over two decades of experience, we’ve revolutionized global
              recruitment, connecting companies and talent worldwide. */}
            </p>
            ...
            <ul className="gap-2 grid grid-rows-3 grid-cols-2 text-sm">
              ...
              <FeatureHighlight
                title="24/7 Support"
                description="Round-the-clock assistance for your global recruitment needs."
              />
            </ul>
          </div>
        </div>
