        ...
        <Card className="w-full max-w-md text-center shadow-lg">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-600">
              We've sent a confirmation email to your inbox. Please verify your email to unlock all features.
            </p>
            <div className="rounded-lg bg-gray-50 p-4 border border-gray-200">
              <h3 className="font-medium text-secondaryColor mb-2">What's Next?</h3>
          ...
          <CardFooter className="flex flex-col space-y-2">
            ...
            {userType === "applicant" ? (
              <Button asChild variant="outline" className="w-full border-main text-main hover:bg-main/10">
                <Link href="/">
